...
export default async function decorate(block) {
  ...
  loadFragment(miniCartPath).then((miniCartFragment) => {
    ...
    console.log(
      "[HEADER] Mini-cart fragment loaded, root element:",
      miniCartElement,
    );
    console.log(
      "[HEADER] Fragment HTML:",
      miniCartElement.outerHTML.substring(0, 200),
    );
    ...
    if (!block) {
      ...
      console.log(
        '[HEADER] Fallback search for div[class*="mini-cart"]:',
        block,
      );
    }
    ...
    if (block) {
      ...
      decorateBlock(block);
      console.log(
        "[HEADER] Block data-block-name after decorateBlock:",
      ...
      loadBlock(block)
        .then(() => {
          ...
          console.log(
            "[HEADER] Block data-block-status after loadBlock:",
