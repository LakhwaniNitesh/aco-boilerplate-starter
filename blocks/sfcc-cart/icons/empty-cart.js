  ...
  return `
    <svg width="80" height="80" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" class="dropin-icon dropin-icon--shape-stroke-2 cart-empty-cart__icon dropin-illustrated-message__icon">
      <g clip-path="url(#clip0_102_196)">
        ...
        <path vector-effect="non-scaling-stroke" d="M5.25 6.37L20.89 8.06L20.14 14.8H6.19" stroke="currentColor" stroke-linejoin="round"></path>
      </g>
      <defs>
        <clipPath id="clip0_102_196">
          <rect vector-effect="non-scaling-stroke" width="19.29" height="19.5" fill="white" transform="translate(2.3501 2.25)"></rect>
        </clipPath>
      </defs>
    </svg>
  `;
